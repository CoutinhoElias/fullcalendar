...
//                $('#visualizar_agenda').modal('show');
            ...
            select: function(start, end){
                ...
                $.ajax({
                    ...
                    beforeSend: function () {
                        //$("#novoEvento .modal-content").html("");
                        //$("#novoEvento").modal("show");
                        $("#novoEvento").dialog({ modal: true, title: event.title, width:500, height:651});
                    },
                    success: function (data) {
                        var novoHtml = $.parseHTML(data.html_form);
                        console.log(novoHtml);
                        $("#novoEvento").html(novoHtml).dialog({ modal: true, title: event.title, width:500, height:651});
